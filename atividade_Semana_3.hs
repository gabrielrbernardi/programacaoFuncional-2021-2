...
subStringDeAte s i t = (drop (i)) (take (i+t) s)
...
cartaÉMenor (v1, n1) (v2, n2)
    | v1 < v2 && n1 == n2 = True
    | v1 >= v2 && n1 == n2 = False
    | v1 == v2 && n1 == "copas" && n2 == "espada" = True
    | v1 == v2 && n1 == "copas" && n2 == "ouro" = True
    | v1 == v2 && n1 == "copas" && n2 == "paus" = True
    | v1 == v2 && n1 == "espada" && n2 == "ouro" = True
    | v1 == v2 && n1 == "espada" && n2 == "paus" = True
    | v1 == v2 && n1 == "ouro" && n2 == "paus" = True
    | otherwise = False
...
-}
--"copas" < "espada" < "ouro" < "paus"
cartaÉMaior (v1, n1) (v2, n2)
    | v1 > v2 && n1 == n2 = True
    | v1 == v2 && n1 == "paus" && n2 == "ouro" = True
    | v1 == v2 && n1 == "paus" && n2 == "espada" = True
    | v1 == v2 && n1 == "paus" && n2 == "copas" = True
    | v1 == v2 && n1 == "ouro" && n2 == "espada" = True
    | v1 == v2 && n1 == "ouro" && n2 == "copas" = True
    | v1 == v2 && n1 == "espada" && n2 == "copas" = True
    | otherwise = False
...
retornaMaior :: Carta -> Carta -> Carta -> Carta
retornaMaior (v1, n1) (v2, n2) (v3, n3)
    | (cartaÉMaior (v1, n1) (v2, n2) || cartaÉIgual (v1, n1) (v2, n2)) && (cartaÉMaior (v1, n1) (v3, n3) || cartaÉIgual (v1, n1) (v3, n3)) = (v1, n1)
    | (cartaÉMaior (v2, n2) (v3, n3) || cartaÉIgual (v2, n2) (v3, n3)) && (cartaÉMaior (v2, n2) (v1, n1) || cartaÉIgual (v2, n2) (v1, n1)) = (v2, n2)
    | (cartaÉMaior (v3, n3) (v1, n1) || cartaÉIgual (v3, n3) (v1, n1)) && (cartaÉMaior (v3, n3) (v2, n2) || cartaÉIgual (v3, n3) (v2, n2)) = (v3, n3)

retornaMenor :: Carta -> Carta -> Carta -> Carta
retornaMenor (v1, n1) (v2, n2) (v3, n3)
    | (cartaÉMenor (v1, n1) (v2, n2) || cartaÉIgual (v1, n1) (v2, n2)) && (cartaÉMenor (v1, n1) (v3, n3) || cartaÉIgual (v1, n1) (v3, n3)) = (v1, n1)
    | (cartaÉMenor (v2, n2) (v3, n3) || cartaÉIgual (v2, n2) (v3, n3)) && (cartaÉMenor (v2, n2) (v1, n1) || cartaÉIgual (v2, n2) (v1, n1)) = (v2, n2)
    | (cartaÉMenor (v3, n3) (v1, n1) || cartaÉIgual (v3, n3) (v1, n1)) && (cartaÉMenor (v3, n3) (v2, n2) || cartaÉIgual (v3, n3) (v2, n2)) = (v3, n3)

naoEhOutrasDuas :: Carta -> Carta -> Carta -> Carta
naoEhOutrasDuas (v1, n1) (v2, n2) (v3, n3) 
    | ((v1, n1) == retornaMaior (v1, n1) (v2, n2) (v3, n3)) && ((v2, n2) == retornaMenor (v1, n1) (v2, n2) (v3, n3)) = (v3, n3)
    | ((v2, n2) == retornaMaior (v1, n1) (v2, n2) (v3, n3)) && ((v3, n3) == retornaMenor (v1, n1) (v2, n2) (v3, n3)) = (v1, n1)
    | ((v3, n3) == retornaMaior (v1, n1) (v2, n2) (v3, n3)) && ((v1, n1) == retornaMenor (v1, n1) (v2, n2) (v3, n3)) = (v2, n2)
    
    | ((v1, n1) == retornaMenor (v1, n1) (v2, n2) (v3, n3)) && ((v2, n2) == retornaMaior (v1, n1) (v2, n2) (v3, n3)) = (v3, n3)
    | ((v2, n2) == retornaMenor (v1, n1) (v2, n2) (v3, n3)) && ((v3, n3) == retornaMaior (v1, n1) (v2, n2) (v3, n3)) = (v1, n1)
    | ((v3, n3) == retornaMenor (v1, n1) (v2, n2) (v3, n3)) && ((v1, n1) == retornaMaior (v1, n1) (v2, n2) (v3, n3)) = (v2, n2)
    
    | otherwise = (v1, n1)

éJogo :: Carta -> Carta -> Carta -> Bool
éJogo (v1, n1) (v2, n2) (v3, n3) = do

    let (mv1, mn1) = retornaMaior (v1, n1) (v2, n2) (v3, n3) :: Carta
        (mv3, mn3) = retornaMenor (v1, n1) (v2, n2) (v3, n3) :: Carta
        (mv2, mn2) = naoEhOutrasDuas (v1, n1) (v2, n2) (v3, n3) :: Carta
    
    if (mn1 == mn2 && mn2 == mn3) && (mv1 == mv2 + 1 && mv1 == mv3 + 2) then True
    else if (mn1 /= mn2 && mn2 /= mn3) && (mv1 == mv2 && mv1 == mv3) then True
    else False
...
mãoGanhadora t1 t2 = error "Indefinido"